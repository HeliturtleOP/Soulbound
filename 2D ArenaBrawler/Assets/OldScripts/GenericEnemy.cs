...
public class GenericEnemy : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (closest != null && Vector2.Distance(transform.position, closest.position) <= stoppingDistance && !closest.GetComponent< GenericSummon>().Dead)
        {
        ...
        if (closest != null && !closest.GetComponent< GenericSummon>().Dead)
        {
